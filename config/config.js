...
let config = {
    ...
    deves: {
        ...
        apidocs: apidocs,
        managementToolsSite: '//registry.gbif-dev.org/',
        dataApiV2: dataApiV2 || '//api-es.gbif-dev.org/v2/',
        dataApi: dataApi || '//api-es.gbif-dev.org/v1/',
        tileApi: tileApi || '//api-es.gbif-dev.org/v1/map/density/tile.png',
        basemapTileApi: basemapTileApi || '//tile.gbif-dev.org',
        identityApi: identityApi || '//api-es.gbif-dev.org/v1/',
        analyticsImg: analyticsImg || 'www-es.gbif-dev.org/sites/default/files/gbif_analytics/',
        domain: 'https://www-es.gbif-dev.org',
        topDomain: 'gbif-dev.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
    ...
    devsolr: {
        ...
        apidocs: apidocs,
        managementToolsSite: '//registry.gbif-dev.org/',
        dataApiV2: dataApiV2 || '//api-solr.gbif-dev.org/v2/',
        dataApi: dataApi || '//api-solr.gbif-dev.org/v1/',
        tileApi: tileApi || '//api-solr.gbif-dev.org/v1/map/density/tile.png',
        basemapTileApi: basemapTileApi || '//tile.gbif-dev.org',
        identityApi: identityApi || '//api-solr.gbif-dev.org/v1/',
        analyticsImg: analyticsImg || 'www-solr.gbif-dev.org/sites/default/files/gbif_analytics/',
        domain: 'https://www-solr.gbif-dev.org',
        topDomain: 'gbif-dev.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
    ...
    uates: {
        ...
        basemapTileApi: basemapTileApi || '//tile.gbif-uat.org',
        identityApi: identityApi || '//api-es.gbif-uat.org/v1/',
        analyticsImg: analyticsImg || 'www-es.gbif-uat.org/sites/default/files/gbif_analytics/',
        domain: 'https://www-es.gbif-uat.org',
        topDomain: 'gbif-uat.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
    ...
    uatsolr: {
        ...
        apidocs: apidocs,
        managementToolsSite: '//registry.gbif-uat.org/',
        dataApiV2: dataApiV2 || '//api-solr.gbif-uat.org/v2/',
        dataApi: dataApi || '//api-solr.gbif-uat.org/v1/',
        tileApi: tileApi || '//api-solr.gbif-uat.org/v1/map/density/tile.png',
        basemapTileApi: basemapTileApi || '//tile.gbif-uat.org',
        identityApi: identityApi || '//api-solr.gbif-uat.org/v1/',
        analyticsImg: analyticsImg || 'www-solr.gbif-uat.org/sites/default/files/gbif_analytics/',
        domain: 'https://www-solr.gbif-uat.org',
        topDomain: 'gbif-uat.org',
        credentials: credentials || '/etc/portal16/credentials',
        redirects: redirects || '/etc/portal16/redirects',
        spamTerms: spamTerms || ('/etc/portal16/spam.txt'),
